...
pipeline {
  ...
  parameters {
    ...
    string(defaultValue: '2020-06', description: 'The release name. Release is uploaded to https://download.eclipse.org/technology/epp/downloads/release/RELEASE_NAME', name: 'RELEASE_NAME')
