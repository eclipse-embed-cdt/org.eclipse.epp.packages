...
cd ${TARGETDIR}
# pattern to match: <product name="eclipse-linuxtools-juno-SR1-RC1-incubation" /> -> "eclipse-linuxtools-juno-SR1-RC1-RC5"
...
for II in `ls *eclipse-*.tar.gz *eclipse-*.zip`; do
  # 20110615-0608_eclipse-testing-juno-SR1-RC1-macosx.cocoa.x86_64.tar.gz
  # eclipse-parallel-juno-SR1-RC1-incubation-macosx-cocoa-x86_64.tar.gz
