...
REPO_ECLIPSE35="${BASE_URL}/eclipse/updates/3.5milestones/S-3.5M5-200902021535/"
...
METADATAREPOSITORIES="${REPO_GALILEO},${REPO_EPP_UDC},${REPO_EPP_GALILEO}"
ARTIFACTREPOSITORIES="${REPO_GALILEO},${REPO_EPP_UDC}"
